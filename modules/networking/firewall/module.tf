...
resource "azurerm_firewall" "fw" {
  ...
  dynamic "management_ip_configuration" {
    ...
    content {
      ...
      #public_ip_address_id = try(management_ip_configuration.value.public_ip_address_id, null) != null ? management_ip_configuration.value.public_ip_address_id : var.public_ip_addresses[try(management_ip_configuration.value.lz_key, var.client_config.landingzone_key)][managment_ip_configuration.value.public_ip_key].id
