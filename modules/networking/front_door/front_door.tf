...
=======
  ...
  dynamic "custom_https_configuration" {
    for_each = try(each.value.custom_https_provisioning_enabled, false) == false ? {} : lower(each.value.custom_https_configuration.certificate_source) != "frontdoor" ? each.value.custom_https_configuration : {certificate_source: "FrontDoor"}
    content {
